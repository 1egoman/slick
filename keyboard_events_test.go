...
var keyEvents = []struct {
	...
	{
		"In chat mode, the message history can be scrolled all the way to the top by pressing 'g'.",
		InitialMessageHistoryState(0, 0), // Selecting index 14, and item 4 is on the bottom
	...
	},
	{
		...
		InitialMessageHistoryState(3, 3), // Selecting index 14, and item 4 is on the bottom
		tcell.NewEventKey(tcell.KeyCtrlU, ' ', tcell.ModNone),
		func(state *State) bool {
	...
	// Editing operations
	{
		...
		tcell.NewEventKey(tcell.KeyCtrlW, ' ', tcell.ModNone),
	...
	},
	{
		...
		tcell.NewEventKey(tcell.KeyCtrlA, ' ', tcell.ModNone),
	...
	},
	{
		...
		tcell.NewEventKey(tcell.KeyCtrlE, ' ', tcell.ModNone),
